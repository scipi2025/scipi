...
export function EventSectionEditor({ sections, onChange }: EventSectionEditorProps) {
  ...
  const updateSection = (index: number, updates: Partial<EventSection>) => {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <Label className="text-base font-semibold">Secțiuni Eveniment</Label>
          <p className="text-sm text-muted-foreground">
            Adaugă secțiuni separate pentru a organiza conținutul (Course description, Programme, etc.)
          </p>
        </div>
                    ...
                    <div className="grid gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          ...
                          variant="outline"
                          size="sm"
                          onClick={() => document.getElementById(`section-files-${index}`)?.click()}
