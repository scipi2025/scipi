...
import { ExternalLink, Building2, HandshakeIcon, LucideIcon, Users } from "lucide-react";
import { useLanguage, getLocalizedContent, type Language } from "@/lib/language-context";
...
export function PartnersPageClient({ partners }: PartnersPageClientProps) {
  ...
  const supporting = partners.filter((p) => p.type === "supporting");
  ...
  return (
    <div className="space-y-12">
      ...
      {/* Partner Sections */}
      <PartnerSection
        title={t("partners.institutional")}
        icon={Building2}
      ...
      <PartnerSection
        title={t("partners.supporting")}
        icon={HandshakeIcon}
        partnersList={supporting}
        language={language}
      />
